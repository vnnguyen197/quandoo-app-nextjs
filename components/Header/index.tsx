      ...
      {dataHeader.map((item, index) => (
        <div className={style.header__main} key={index}>
          ...
          <div className={style.header__right}>
            ...
            <div className={`${style.header__item} ${style['header__item--user']}`}>
              <FontAwesomeIcon className={style.header__iconUser} icon={faCircleUser} size="lg" fixedWidth />
            </div>
            <div className={`${style.header__item} ${style['header__item--right4']}`}> {item.sub_title4}
